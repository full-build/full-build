...
let CheckEqualityWithPermutation () =
    let antho1 = {
        ...
        Repositories = [ { Vcs = VcsType.Git; Name = RepositoryName.Bind "cassandra-sharp"; Url = RepositoryUrl "https://github.com/pchalamet/cassandra-sharp" }
                         { Vcs = VcsType.Git; Name = RepositoryName.Bind "cassandra-sharp-contrib"; Url = RepositoryUrl "https://github.com/pchalamet/cassandra-sharp-contrib" } ] |> set
        Projects = [ { Output = AssemblyRef.Bind "cqlplus"
                       OutputType = OutputType.Exe
                       ProjectGuid = ProjectRef (ParseGuid "0a06398e-69be-487b-a011-4c0be6619b59")
    ...
    let antho2 = {
        ...
        Repositories = [ { Vcs = VcsType.Git; Name = RepositoryName.Bind "cassandra-sharp-contrib"; Url = RepositoryUrl "https://github.com/pchalamet/cassandra-sharp-contrib" } 
                         { Vcs = VcsType.Git; Name = RepositoryName.Bind "cassandra-sharp"; Url = RepositoryUrl "https://github.com/pchalamet/cassandra-sharp" } ] |> set
        Projects = [ { Output = AssemblyRef.Bind "cqlplus"
                       OutputType = OutputType.Exe
                       ProjectGuid = ProjectRef (ParseGuid "0a06398e-69be-487b-a011-4c0be6619b59")
                       RelativeProjectFile = ProjectRelativeFile "cqlplus/cqlplus-net45.csproj"
