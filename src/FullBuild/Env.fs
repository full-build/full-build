...
let MSBUILD_PROJECT_FOLDER3 = sprintf @"%s/%s/%s/" MSBUILD_SOLUTION_DIR MASTER_REPO PROJECT_FOLDER
...
let MSBUILD_PACKAGE_FOLDER3 = sprintf @"%s/%s/%s/" MSBUILD_SOLUTION_DIR MASTER_REPO PACKAGE_FOLDER
