...
let GenerateProjectNode (project : Project) =
    ...
    XElement(NsDgml + "Node",
        ...
        XAttribute(NsNone + "FxVersion", project.FxVersion.toString ),
        XAttribute(NsNone + "FxProfile", project.FxProfile.toString ),
        XAttribute(NsNone + "FxIdentifier", project.FxIdentifier.toString ),
