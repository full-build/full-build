...
%FULLBUILD% repo add cassandra-sharp git file://%LOCALCSREPO% nunit msbuild || goto :ko
%FULLBUILD% repo add cassandra-sharp-contrib git file://%LOCALCSCREPO% nunit msbuild || goto :ko
...
%FULLBUILD% publish --version %VERSION% --status alpha cqlplus.zip || goto :ko
%FULLBUILD% push --full %VERSION% || goto :ko
